...
export default function App() {
  ...
  return <div dir="rtl" className="site-shell">
    ...
    <div className="national-strip" role="img" aria-label="شريط زخرفي بمناسبة اليوم الوطني السعودي"></div>
    <footer className="footer"><div><strong>tilawat haramain</strong><p>محتوى إسلامي، تلاوات خاشعة وأحاديث.</p></div><div className="footer-links"><button onClick={() => go('/quran')}>مصحف</button><button onClick={() => go('/hadith')}>الأحاديث</button><button onClick={() => go('/sources')}>المصادر والتخريج</button><button onClick={() => go('/search')}>البحث الشامل</button></div><div className="footer-bottom"><span>© 2026 tilawat haramain</span></div></footer>
  </div>
}
